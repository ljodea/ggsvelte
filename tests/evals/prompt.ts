...
- Coord: {"type": "flip"} makes horizontal charts (still map x=category, y=value). A post-stat coordinate transform is {"type":"transform","x"?: {"transform":"identity"|"log10"|"sqrt","limits"?: [min,max],"reverse"?: bool,"expand"?: bool},"y"?: same,"clip"?: bool}. Coordinate transforms preserve stat inputs; scale transforms do not.
