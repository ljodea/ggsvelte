/**
 * Data and layer binding: resolve NamedData / dataset refs into ColumnTables,
 * and resolve per-layer aes channels into LayerBinding (with structural
 * geom/stat validation and structured PipelineErrors).
 */
import type { Aes, BarParams, ChannelValue, LayerSpec, PortableSpec } from "@ggsvelte/spec";
