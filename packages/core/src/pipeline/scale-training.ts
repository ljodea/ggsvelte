/**
 * Positional and color/fill scale training for the core pipeline.
 * Collects axis evidence across layer frames, trains band/continuous scales,
 * and resolves value-stable ordinal + sequential color scales (with legends).
 */
import type { ColorScaleSpec, LayerSpec, PositionScaleSpec } from "@ggsvelte/spec";
