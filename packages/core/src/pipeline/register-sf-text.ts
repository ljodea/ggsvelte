/**
 * Granular registration (#1420): geom sf_text + stat sf_coordinates. Imported by the matching <Geom*>
...
export function registerSfText(): void {
  if (registered) return;
  registered = true;
  registerGeomBatch("sf_text", (frame, fx, color, fill, styles, warnings) =>
