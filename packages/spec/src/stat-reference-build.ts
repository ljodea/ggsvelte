/**
 * STAT_REFERENCE builder. Gen-only: `scripts/gen-reference-catalogs.ts`.
 * Runtime uses generated/stat-reference-data.ts.
 */
import {
  GEOM_DEFAULTS,
  KNOWN_GEOMS,
...
export function buildStatReference(): Readonly<Record<StatName, StatReferenceEntry>> {
