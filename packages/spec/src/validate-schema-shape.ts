...
export const GEOM_BRANCHES = {
  ...
  count: CountLayerSchema,
  violin: ViolinLayerSchema,
  function: FunctionLayerSchema,
  ...
  linerange: LinerangeLayerSchema,
  pointrange: PointrangeLayerSchema,
  crossbar: CrossbarLayerSchema,
