    ...
    Type.Object(
      {
        ...
        scheme: Type.Optional(
          Type.Union(COLOR_SCHEME_NAME_SCHEMAS, {
            description:
              'Named color scheme: categorical "observable10" (default), "ipsum", "flexoki", "tableau10", and "colorblind"; or sequential family "viridis" (default), "magma", "plasma", "inferno", "cividis", "turbo". Sequential-family names may also be used with ordinal scales (discrete sampling). When type is omitted, the named scheme selects its ordinal or sequential scale family.',
          }),
        ),
        reverse: Type.Optional(
