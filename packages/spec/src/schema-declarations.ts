  ...
  PointLayer: Type.Object(
    {
      geom: Type.Literal("point", {
        description:
          "Point geometry: one mark per data row. Use for scatter plots, dot plots, bubbles, correlation views. With summary_bin (#817), manual (#814), or stat sum for geom_count overplotting.",
      }),
      stat: Type.Optional(
        Type.Union(
          [
