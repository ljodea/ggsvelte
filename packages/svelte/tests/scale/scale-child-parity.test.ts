...
describe("scale-child parity (all 100 shells)", () => {
  it(`enumerates exactly 100 helpers (got ${String(helpers.length)})`, () => {
...
/**
 * The 100-shell sweep above runs on ScaleRegistryHost, which provides the
