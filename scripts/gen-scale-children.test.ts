...
describe("SHELL_MANIFEST completeness", () => {
  ...
  it("cardinality: 69 component files + gray/colour aliases", () => {
    expect(SHELL_MANIFEST).toHaveLength(69);
    expect(manifestAliases().size).toBe(15);
