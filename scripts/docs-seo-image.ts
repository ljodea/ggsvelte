...
export const OG_HOME_FILENAME = "home-v3.png";
...
export const OG_HOME_ALT =
  "ggsvelte homepage: fast, agent-native grammar of graphics with a cold-mount area benchmark against LayerCake, TanStack Charts, Unovis, and SveltePlot.";
