 ...
 * millions of pounds sterling. examples/line/time-axis draws the same series
 * with its calendar axis; here the axis is what gets taken away.
 */
export const britishExports: { year: number; value: number }[] = [
