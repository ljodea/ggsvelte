...
export const THEME_SPECIMENS: readonly ThemeSpecimenConfig[] = [
  ...
  {
    name: "stata_mono",
    label: BY_NAME.stata_mono.label,
    caption: "Stata s2mono: gray plot region and monochrome y-grid.",
    kind: "ridership-line",
    scheme: BY_NAME.stata_mono.scheme,
    legendFocus: true,
  },
  {
    name: "solarized",
  ...
  {
    name: "calc",
    label: BY_NAME.calc.label,
    caption: "LibreOffice Calc: white panel, gray border and y-grid.",
    kind: "attendees-dodge",
    scheme: BY_NAME.calc.scheme,
    legendFocus: true,
  },
  {
    name: "excel",
    label: BY_NAME.excel.label,
    caption: "Excel 97: gray panel and black grid — the classic ugly look.",
    kind: "ridership-line",
    scheme: BY_NAME.excel.scheme,
    legendFocus: true,
  },
  {
    name: "excel_new",
    label: BY_NAME.excel_new.label,
    caption: "Modern Excel: gray text, hairline y-grid, no ticks or border.",
    kind: "revenue-cols",
    scheme: BY_NAME.excel_new.scheme,
    legendFocus: false,
  },
  {
    name: "base",
