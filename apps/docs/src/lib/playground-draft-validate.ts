      ...
      diagnostics: [
        {
          ...
          code: "invalid-json",
          path: "",
          message: error instanceof Error ? error.message : "The spec is not valid JSON.",
      ...
      diagnostics: [
        {
          ...
          code: "share-limit",
          path: "",
          message: error instanceof Error ? error.message : "The spec exceeds playground limits.",
          fix: "Use a smaller portable spec.",
        },
      ],
    };
